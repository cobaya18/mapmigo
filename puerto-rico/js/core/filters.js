...
/**
 * Build the category + region filter button groups
 * for both desktop sidebar and mobile filter sheet (if present).
 */
...
/**
 * Collect active values from one or more button containers.
 */
