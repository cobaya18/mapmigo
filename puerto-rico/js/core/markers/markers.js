...
import { buildPopupHtml } from "./popup/popup-template.js";
import { highlightMarker } from "./markers/marker-highlight.js";
...
export function initMarkers() {
  ...
  ============================================================ */
  if (isMobile()) {
    L.Map.prototype.openPopup = function () {
      return this;
    };
    L.Popup.prototype.openOn = function () {
      return this;
    };
  } else {
  ...
  state.places.forEach((place, index) => {
    ...
    if (isMobile()) {
      ...
      marker.on("click", () => {
        ...
        bus.emit("place:openSheet", { place, key, index });
      });
    }
      ...
      setTimeout(() => {
        ...
        if (seeMoreBtn && moreSection) {
          seeMoreBtn.onclick = (ev) => {
            ...
            seeMoreBtn.textContent = moreSection.classList.contains(
              "expanded"
            )
              ? "See less"
              : "See more";
...
/* ============================================================
   HIGHLIGHT ANIMATION (moved to markers/marker-highlight.js)
============================================================ */

export { highlightMarker } from "./markers/marker-highlight.js";
